...
public class PantallaLogin extends javax.swing.JFrame {
    ...
    private void registrar() {
       ...
       if(nombreUsuario.isEmpty() || txtContraseña.getText().equals("")){
            ...
            try {
                if (creararchivo.exists()) {
                    ...
                    crearformater.format("Usuario: %s%nContraseña: %s", nombreUsuario, txtContraseña.getText());
